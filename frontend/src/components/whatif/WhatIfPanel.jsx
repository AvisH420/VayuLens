...
// The head is fixed; .drawer-body scrolls so the form never fights the map.
  ...
  return (
    <aside className="drawer drawer-left glass">
      <div className="drawer-head">
        <h3>What-if</h3>
        <button className="drawer-close" onClick={onClose} aria-label="Close what-if panel">
          <X size={17} strokeWidth={2.1} aria-hidden="true" />
        </button>
      </div>

      <div className="drawer-body" ref={animate}>
